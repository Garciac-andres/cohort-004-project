...
export function enrollUser(
  ...
  // Notify the course's instructor of the new enrollment. Look up the course
  // (for instructor + title) and the enrolling student's name. Guarded so a
  // missing row never breaks the enrollment itself.
  const course = db
